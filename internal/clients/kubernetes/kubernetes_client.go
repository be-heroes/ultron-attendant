...
func NewKubernetesClient(kubernetesMasterUrl string, kubernetesConfigPath string) (*KubernetesClient, error) {
	var err error
...
func (kc *KubernetesClient) GetNodes() ([]corev1.Node, error) {
